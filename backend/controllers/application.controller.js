...
const deleteApplication = async (req, res) => {
    try {
        ...
        await Job.findByIdAndUpdate(application.job, { $pull: { applications: applicationId } });
...
module.exports = { applyJob, getAppliedJobs, getApplicants, updateStatus, deleteApplication };